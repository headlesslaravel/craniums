<template>
    ...
    <div class="relative h-screen flex overflow-hidden bg-white">
        ...
        <div class="hidden lg:flex lg:flex-shrink-0 bg-gray-100">
        ...
        <div class="flex-1 overflow-auto focus:outline-none">
            <div
                class="flex-shrink-0 flex h-16 bg-white border-b border-gray-200"
            >
                <button
                    type="button"
                    ...
                    <div class="ml-4 flex items-center md:ml-6">
                        ...
                        >
                            ...
                            <div
                                ...
                                class="sm:hiddenorigin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg py-1 bg-white ring-1 ring-black ring-opacity-5 focus:outline-none"
                                role="menu"
            ...
            <main data-test="main" class="flex-1 relative pb-8 z-0 overflow-y-auto bg-white">
                <div>
