                    ...
                    <div class="flex items-center">
                        ...
                        <div class="w-10 h-full bg-gray-50">
                            <button @click.prevent="remove(index)">
                                <slot name="remove">
                                    <svg class="h-6 w-6 text-gray-500 hover:text-black cursor-pointer" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" data-test="jet-picker-clear-make_id"><path d="M6 18L18 6M6 6l12 12" stroke-linecap="round" stroke-linejoin="round" stroke-width="2"></path></svg>
                                </slot>
                            </button>
                        </div>
                    </div>
